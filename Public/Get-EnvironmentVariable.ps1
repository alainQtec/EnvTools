...
Set-Alias -Name 'Read-Envt' -Description 'Reads environment Variable(s) from a .env file.' -Value 'Get-EnvironmentVariable -FromFilesOnly' -Option AllScope
Set-Alias -Name 'Read-EnvironmentVariable' -Description 'Reads environment Variable(s) from a .env file.' -Value 'Get-EnvironmentVariable -FromFilesOnly' -Option AllScope